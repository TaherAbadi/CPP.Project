...
//for loading the game
    ...
    int difficulty;
    string txt=".txt";
    cout<<"\n\n                                             <<Welcome to Brick Smash!>>  "<<endl<<"\n\nBY PARSA ASEMI AND TAHER ABADI ;)\n\n\n\n";
    ...
    for(int i=0; i<5; i++)
    {
        ...
        {
            cout<<"history "<<5-i<<" : "<<history_score[i]<<endl;
            history_counter++;
...
game.ball.damage=1;
    while(flag_end==1)
    {
        ...
        for(int i=0;i<game.player.level;i++)
        {
            ...
            {
                if(brick[i][j].strength!=0)
                {   //barkhord be rast o chape brick
                    ...
                    //barkhord be paein o balaie brick
